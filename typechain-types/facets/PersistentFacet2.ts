...
export interface PersistentFacet2Interface extends utils.Interface {
  functions: {
...
export interface PersistentFacet2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PersistentFacet2Interface;
