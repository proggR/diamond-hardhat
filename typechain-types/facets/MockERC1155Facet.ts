...
export interface MockERC1155FacetInterface extends utils.Interface {
  functions: {
...
export interface MockERC1155Facet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockERC1155FacetInterface;
